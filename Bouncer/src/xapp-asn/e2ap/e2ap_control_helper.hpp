...
struct ric_control_helper{
  ric_control_helper(void):requestor_id(1), instance_id(1), func_id(0), action_id(1), control_ack(-1), cause(0), sub_cause(0), control_status(1), control_msg(0), control_msg_size(0), control_header(0), control_header_size(0), call_process_id(0), call_process_id_size(0){};

  long int requestor_id, instance_id, func_id, action_id, control_ack, cause, sub_cause, control_status;
  ...
  uint8_t *control_outcome_format1;
  size_t control_outcome_format1_size;
